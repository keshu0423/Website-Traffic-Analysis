...
KPI = {
    "raw_rows": 226278, "raw_cols": 9,
    "clean_rows": 122567, "clean_cols": 19,
    "duplicates_removed": 103711,
    "date_min": "2021-08-19", "date_max": "2021-08-25",
    "countries": 212, "cities": 11993, "artists": 2420,
    "total_sessions": 115836, "total_users": 36749,
    "new_users": 28724, "returning_users": 8025,
    "total_pageviews": 73360, "total_clicks": 32499,
    "total_previews": 16708,
    "bounce_rate": 59.93,
    "avg_duration_sec": 43.4, "avg_duration_min": 0.72,
    "avg_pages_per_session": 0.63,
    "conversion_rate": 26.88,
    "top_landing": {
        "/": 17867, "/artist/tesher": 3257,
        "/artist/tesher/track/jalebi_baby": 2247,
        "/artist/tundra_beats": 1478, "/artist/anne_marie": 1449,
    },
    "top_exit": {
        "/": 17857, "/artist/tesher": 3265,
        "/artist/tesher/track/jalebi_baby": 2262,
        "/artist/tundra_beats": 1479, "/artist/anne_marie": 1452,
    },
    "top_sources": {
        "Google": 36803, "Direct": 30593,
        "Instagram": 24552, "Facebook": 18578, "YouTube": 6100,
    },
    "top_categories": {
        "Social Media": 49230, "Organic Search": 36803,
        "Direct": 30593, "Referral": 5941,
    },
    "top_countries": {
        "United States": 28664, "India": 18689, "France": 10565,
        "Saudi Arabia": 7682, "United Kingdom": 5095,
    },
    "top_devices": {"Mobile": 73523, "Desktop": 37003, "Tablet": 12041},
    "top_events":  {"pageview": 73360, "click": 32499, "preview": 16708},
    "bounce_by_source": {
        "Direct": 59.44, "Organic Search": 60.03,
        "Referral": 60.19, "Social Media": 60.13,
    },
    "bounce_by_device": {"Desktop": 60.18, "Mobile": 59.75, "Tablet": 60.23},
    "peak_hour": 19, "low_hour": 2,
    "category_performance": {
        "Direct":         {"sessions": 29003, "bounce_rate": 59.44, "avg_duration": 44.2, "conversion_rate": 27.77},
        "Organic Search": {"sessions": 34846, "bounce_rate": 60.03, "avg_duration": 43.2, "conversion_rate": 27.41},
        "Referral":       {"sessions": 5576,  "bounce_rate": 60.19, "avg_duration": 45.9, "conversion_rate": 27.98},
        "Social Media":   {"sessions": 46411, "bounce_rate": 60.13, "avg_duration": 42.8, "conversion_rate": 27.36},
    },
}
...
def build():
    ...
    toc_rows = [
        ...
        ("5.", "Website KPI Dashboard", "6"),
        ("6.", "Exploratory Data Analysis", "7"),
        ("7.", "Traffic Source & Channel Performance", "8"),
        ("8.", "User Journey & Navigation Analysis", "9"),
        ("9.", "Bounce Rate Deep-Dive", "10"),
        ("10.", "Time-Series Traffic Analysis", "11"),
        ("11.", "Visualisations Gallery", "12"),
        ("12.", "Business Insights (10 Findings)", "14"),
        ("13.", "Five Strategic Recommendations", "15"),
        ("14.", "Data Limitations & Transparency", "16"),
        ("15.", "Conclusion & Action Roadmap", "16"),
    ]
    toc_data = []
    ...
    bullets_exec = [
        "Social Media drives the highest session volume (49,230 sessions / 40.1%) among all traffic categories.",
        f"Bounce rate stands at {KPI['bounce_rate']}% — indicating more than half of sessions consist of a single pageview.",
        "Average session duration is only 43.4 seconds, suggesting most visitors do not deeply engage with content.",
        "Conversion rate of 26.88% shows that roughly 1 in 4 sessions ends in a store click — a healthy funnel outcome.",
        "The United States (28,664 events) and India (18,689 events) are the top two geographic markets.",
        ...
        "The homepage ('/') is both the #1 landing page (17,867 sessions) and the #1 exit page (17,857 sessions).",
    ]
    ...
    # ════════════════════════════════════════════════════════════════════════
    section_header(story, "5. Website KPI Dashboard", ST)

    story.append(Paragraph(
        "The following table presents the primary web-analytics Key Performance Indicators (KPIs) "
    ...
    story.append(Paragraph(
        ...
        "single-page visits — consistent with the high 59.93% bounce rate. The homepage and Tesher's "
    ...
    warn_box(story,
        ...
        "The overall 59.93% bounce rate is real — calculated from the session structure.", ST)
    ...
    insights = [
        ("High Bounce Rate Requires Immediate Attention",
         f"59.93% of sessions contain only one pageview. This is significantly above the "
        ...
        ("Conversion Rate of 26.88% Indicates Strong Funnel Intent",
        ...
        ("Short Average Session Duration (43.4 s) Signals Shallow Engagement",
         ...
         "The 59.93% bounce rate contributes heavily. Bounced sessions have 0 s duration, "
        ...
        ("Homepage is Both Primary Entry and Exit Point",
         f"The homepage '/' is the #1 landing page ({17867:,} sessions) and #1 exit page ({17857:,} sessions).",
    ...
    recs = [
        ("Implement Above-the-Fold Audio Preview",
         f"Bounce rate is 59.93% and average session duration is only {KPI['avg_duration_sec']}s. "
        ...
        ("Add Related Content Discovery on All Pages",
         f"The homepage is the #1 exit page ({17857:,} sessions) and average pages per session "
         ...
         "Increasing avg pages/session from 0.63 to 1.2 would double content exposure, "
        ...
        ("Redesign the Homepage as a Curated Discovery Hub",
         f"The homepage '/' attracts {17867:,} sessions (15.4%) but exits at the same rate, "
